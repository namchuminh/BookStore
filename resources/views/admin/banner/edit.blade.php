...
<section class="content">
    <div class="container-fluid">
        <form class="card card-default" method="POST" action="{{ route('admin.banner.update', $banner->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT') <!-- Sử dụng PUT để cập nhật bản ghi -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="book_id" id="book_id">
                                ...
                                @foreach($books as $book)
                                    <option value="{{ $book->id }}" {{ $banner->book_id == $book->id ? 'selected' : '' }}>
                                        {{ $book->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="position" id="position">
                                <option value="slide" {{ $banner->position == 'slide' ? 'selected' : '' }}>Slide</option>
