...
Route::get('/the-loai', [UserCategoryController::class, 'index'])->name('user.category.index');
...
Route::get('/lien-he', [UserContactController::class, 'index'])->name('user.contact.index');
